          ...
          <div className="flex gap-4">
            {siteConfig.socialLinks.map((link) => (
              <a
                ...
                className="flex h-12 w-12 items-center justify-center rounded-lg border border-border text-muted transition-all hover:border-accent/50 hover:text-accent"
              >
